...
exports.run = async (client, message, args) => {
  ...
  if (!message.member.permissions.has("MANAGE_GUILD")) return message.reply(`<a:red_1:740292869046140989> Bu komutu kullanabilmek için **Sunucuyu Yönet** iznine sahip olmalısın!`); 
